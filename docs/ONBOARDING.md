...
For the full history of the LLM-wiki / second-brain effort, also read [second-brain-core docs/ONBOARDING.md](https://github.com/SpillwaveSolutions/second-brain-core/blob/main/docs/ONBOARDING.md). This file is the OKF Agent Graph (AGER)-scoped binding.
